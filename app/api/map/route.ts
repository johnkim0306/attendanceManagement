...
export async function GET(req) {
  ...
  try {
    ...
    // Sort data by sessions in descending order and take the top 10
    const top10Countries = data.sort((a, b) => b.sessions - a.sessions).slice(0, 10);

    return NextResponse.json(top10Countries);
  } catch (error) {
