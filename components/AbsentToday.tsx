...
const AbsentToday = () => {
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark absent-today">
      ...
      <p className="text-title-md font-bold text-black dark:text-white">{absentToday !== null ? absentToday : 'Loading...'}</p>
