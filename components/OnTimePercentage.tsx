...
const OnTimePercentage = () => {
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark on-time-percentage">
      ...
      <p className="text-title-md font-bold text-black dark:text-white">{onTimePercentage !== null ? `${onTimePercentage.toFixed(2)}%` : 'Loading...'}</p>
      <h3 className="text-sm font-medium">On-Time Percentage</h3>
    </div>
  );
};
